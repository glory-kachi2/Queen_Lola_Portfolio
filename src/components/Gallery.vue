...
const portraits = [
  {
    id: 1,
    image: new URL('@/assets/images/gymnastics.jpg', import.meta.url).href,
    alt: 'Model',
  },
  {
    id: 2,
    image: new URL('@/assets/images/holding_bat.jpg', import.meta.url).href,
    alt: 'Model',
  },
  {
    id: 3,
    image: new URL('@/assets/images/lying_holding_ball.jpg', import.meta.url).href,
    alt: 'Model',
  },
  {
    id: 4,
    image: new URL('@/assets/images/model-tying-scarf.jpg', import.meta.url).href,
    alt: 'Model',
  },
  {
    id: 5,
    image: new URL('@/assets/images/model-leaning-on-court.jpg', import.meta.url).href,
    alt: 'Model',
  },
  {
    id: 6,
    image: new URL('@/assets/images/sitting_on_court.jpg', import.meta.url).href,
    alt: 'Model',
  },
]
        ...
        >
          ...
          <div class="overflow-hidden bg-slate-300 relative aspect-square">
            ...
            >
              ...
              >
                <p class="text-white text-lg font-semibold">View Photo</p>
